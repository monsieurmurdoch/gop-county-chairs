#!/usr/bin/env python3
"""Merge Missouri data into main county-chairs.js file"""

import json
import re

# Read Missouri data
with open('/Users/robertmalka/Desktop/gop-county-chairs/scraper/missouri_chairs.json', 'r') as f:
    missouri_chairs = json.load(f)
...
# Merge Missouri data (replace existing MO entries)
for chair in missouri_chairs:
...
print(f"Merged {len(missouri_chairs)} Missouri chairs")
...
print("Updated county-chairs.js")
