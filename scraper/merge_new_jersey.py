#!/usr/bin/env python3
"""Merge New Jersey data into main county-chairs.js file"""

import json
import re

# Read New Jersey data
with open('new_jersey_chairs.json', 'r') as f:
    new_jersey_chairs = json.load(f)
...
# Merge New Jersey data (replace existing NJ entries)
for chair in new_jersey_chairs:
...
print(f"Merged {len(new_jersey_chairs)} New Jersey chairs")
