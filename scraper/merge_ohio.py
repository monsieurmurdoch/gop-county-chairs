#!/usr/bin/env python3
"""Merge Ohio data into main county-chairs.js file"""

import json
import re

# Read Ohio data (from root directory where parse_ohio.py saved it)
with open('ohio_chairs.json', 'r') as f:
    ohio_chairs = json.load(f)
...
# Merge Ohio data (replace existing OH entries)
for chair in ohio_chairs:
...
print(f"Merged {len(ohio_chairs)} Ohio chairs")
